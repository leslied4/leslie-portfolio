				...
				<div className="mb-7">
					...
					<ul className="leading-loose">
						<li className="font-general-regular text-ternary-dark dark:text-ternary-light">
							<span>{'Name'}: </span> {project.client_name}
						</li>
						<li className="font-general-regular text-ternary-dark dark:text-ternary-light">
							<span>{'Website'}: </span>
							{project.hasWebsite && <a href={project.link} className='hover:underline hover:text-indigo-500 dark:hover:text-indigo-400 cursor-pointer duration-300 underline'
								aria-label="Website"
							>
								VISIT
							</a>
